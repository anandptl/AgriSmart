        ...
        <div class="dashboard">
            ...
            <aside class="sidebar">
                ...
                <ul class="menu">
					...
					<a href="/Price/buyers"><i class="fa-solid fa-indian-rupee-sign"></i><span>Crop Prices</span></a>
					<a href="/Farmer-details"><i class="fa-solid fa-person-digging"></i><span>Farmers Details</span></a>
                </ul>
			...
			<header class="top-nav">
                ...
                <div class="nav-right">
                    ...
                    <div class="user-profile">
                        <span>Buyers</span>
                        <img src="https://ui-avatars.com/api/?name=Buyers&background=random" alt="Profile">
                    </div>
                </div>
            </header>
            ...
            <main class="main">
                <div class="profile-card">
					...
					<form action="/update-Buyer-Profile" method="POST" enctype="multipart/form-data">
