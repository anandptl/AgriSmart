...
<head>
    ...
    <title>AgriSmart | Admin - Organic Process</title>
                ...
                <ul class="menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu" id="processSubmenu">
                            <li><a href="#" class="active"><i class="fa-solid fa-circle-dot"></i> Organic
                                    Process</a></li>
                            <li><a href="/Admin-Inorganic-Process"><i class="fa-solid fa-circle-dot"></i> Inorganic
                                    Process</a></li>
                        </ul>
                    </li>
            ...
            <main class="main">
                ...
                <div class="card">
                    ...
                    <section id="add" class="tab-box active">
                        <form action="/admin/process/organic/save-all" method="post">
                            <div class="sec-title green">
                                <i class="fa fa-leaf"></i> Organic Process Details
                            </div>
                    ...
                    <section id="delete" class="tab-box">
                       <form action="/admin/process/organic/delete-all" method="post">
                            <div class="sec-title green">
                                <i class="fa fa-leaf"></i> Organic Process Details
                            </div>
                           <div class="field">
